...
parser = argparse.ArgumentParser(description="Exportiere Heimspiele in der Steingrube als iCal-Datei von fussball.de")
...
try:
    ...
    # Vereinsspielplan nur Heimspiele 
    URL = (
